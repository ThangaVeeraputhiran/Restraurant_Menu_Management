...
function exportAnalyticsReport() {
    ...
    const report = {
        ...
        hourlyTraffic: getHourlyTraffic(orders),
        topSellingItems: getTopSellingItems(orders),
        orders: orders
    };
    ...
    const link = document.createElement('a');
    link.href = url;
    link.download = `analytics_report_${period}_${new Date().toISOString().split('T')[0]}.json`;
    link.click();
    URL.revokeObjectURL(url);
}
